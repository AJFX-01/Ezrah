...
│   └── server.ts
├── tests/
│   ├── getAllCryptocurrencies.test.ts
│   └── ...other tests
├── .env
├── .gitignore
├── package.json
...
Project Link: [https://github.com/your-username/graphql-coinmarketcap-server](https://github.com/your-username/graphql-coinmarketcap-server)
```
